<x-admin-layout title="Purchase & Withdrawal Fee Settings">
<div class="p-4 lg:p-6">
    <div class="space-y-4 overflow-hidden">
        <div class="flex flex-col sm:flex-row lg:justify-between lg:items-center gap-4">
            <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">Purchase & Withdrawal Fee Settings</h1>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
            <form method="POST" action="{{ route('admin.settings.fees.update') }}" class="p-6 space-y-6">
                @csrf
                @method('PUT')
