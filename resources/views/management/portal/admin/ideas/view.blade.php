                        ...
                        <div>
                            ...
                            <dl class="space-y-3">
                                <div>
                                    ...
                                    <dd class="text-sm text-gray-900 dark:text-gray-100">{{ $idea->title ?? 'N/A' }}</dd>
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Description</dt>
                                    <dd class="text-sm text-gray-900 dark:text-gray-100">{{ $idea->description ?? 'No description' }}</dd>
                                </div>
                                <div>
