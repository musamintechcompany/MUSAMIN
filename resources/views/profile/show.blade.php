<x-app-layout>
    ...
    <div>
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8 space-y-6">
            ...
            @if (Laravel\Fortify\Features::canUpdateProfileInformation() && ($settings->profile_information_required ?? true))
            ...
            @if (Laravel\Fortify\Features::enabled(Laravel\Fortify\Features::updatePasswords()) && ($settings->password_change_required ?? true))
                <!-- Password Section -->
                <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg">
            ...
            @if (Laravel\Fortify\Features::canManageTwoFactorAuthentication() && ($settings->two_factor_auth_required ?? true))
            ...
            @if (Laravel\Jetstream\Jetstream::hasAccountDeletionFeatures() && ($settings->account_deletion_required ?? true))
