            ...
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                    <div class="sticky top-0 flex items-center py-2 mb-6 bg-white dark:bg-gray-800">
                        ...
                        <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-200">Today's Exchange Rates</h2>
                    </div>
                    ...
                    <div class="p-6 rounded-lg bg-gray-50 dark:bg-gray-700">
                        <h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Recent Rate Changes</h3>
                        
                        <div class="space-y-3">
                            <div class="flex items-center justify-between py-2 border-b border-gray-200 dark:border-gray-600">
                                <div>
                                    <p class="font-medium text-gray-900 dark:text-white">Standard Rate</p>
                                    <p class="text-sm text-gray-600 dark:text-gray-300">January 15, 2024</p>
                                </div>
                                <div class="text-right">
                                    <p class="font-medium text-gray-900 dark:text-white">1 USD = 100 Coins</p>
                                    <p class="text-sm text-green-600">No change</p>
                                </div>
                            </div>
                            
                            <div class="flex items-center justify-between py-2 border-b border-gray-200 dark:border-gray-600">
                                <div>
                                    <p class="font-medium text-gray-900 dark:text-white">Withdrawal Fee Update</p>
                                    <p class="text-sm text-gray-600 dark:text-gray-300">December 1, 2023</p>
                                </div>
                                <div class="text-right">
                                    <p class="font-medium text-gray-900 dark:text-white">Fee: 5%</p>
                                    <p class="text-sm text-red-600">Reduced from 7%</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex">
                            ...
                            <div>
                                ...
                                <ul class="mt-2 space-y-1 text-sm text-yellow-700 dark:text-yellow-300">
                                    <li>• Rates are updated daily at 12:00 AM UTC</li>
                                    <li>• Withdrawal fees help maintain platform operations</li>
                                    <li>• Minimum withdrawal amount is 1000 coins</li>
                                    <li>• Rates may vary during high-volume periods</li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            coinsInput.addEventListener('input', function() {
                ...
                const usd = (coins / 100) * 0.95; // 5% fee
