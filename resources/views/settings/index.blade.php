<x-app-layout>
            ...
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="space-y-4">
                        ...
                        <!-- Referrals -->
                        <div class="flex items-center justify-between p-4 rounded-lg cursor-pointer bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600" onclick="window.location.href='#'">
                            <div class="flex items-center">
    ...
    <!-- Coming Soon Modal -->
    <div id="comingSoonModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
        <div class="flex items-center justify-center min-h-full p-4 text-center">
            <div class="w-full max-w-md p-6 overflow-hidden text-left align-middle transition-all transform bg-white rounded-lg shadow-xl dark:bg-gray-800">
                ...
                <p class="mb-6 text-gray-600 dark:text-gray-300">This feature is coming soon in few days time.</p>
    ...
    <div id="logoutModal" class="fixed inset-0 hidden overflow-y-auto" style="z-index: 9999999;">
        <div class="flex items-center justify-center min-h-full p-4 text-center">
