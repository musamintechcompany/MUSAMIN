...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Hello {{ $order->store->user->name }},</p>
            
            <p>Great news! You have received a new order in your store <strong>{{ $order->store->name }}</strong>.</p>
            ...
            <div style="border: 1px solid #e5e7eb; padding: 15px; margin: 20px 0;">
                ...
                <p><strong>Customer Email:</strong> {{ $order->delivery_email }}</p>
            ...
            <div style="margin: 30px 0; padding: 20px; background: #dbeafe; border: 1px solid #3b82f6;">
                <h4>Next Steps:</h4>
                <ol>
                    <li>Log into your store dashboard to view full order details</li>
                    <li>Prepare the items for shipping</li>
                    <li>Mark the order as "Shipped" when you send it</li>
                    <li>The customer will confirm receipt, and payment will be released</li>
                </ol>
            </div>
            
            <p>You can manage this order and communicate with the customer through your store dashboard.</p>
        </div>
