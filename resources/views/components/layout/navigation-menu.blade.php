<header class="bg-white shadow-sm dark:bg-gray-800">
    ...
    <div class="flex items-center justify-between p-4">
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="relative">
                <button id="notificationButton" class="relative p-2 text-gray-600 rounded-full dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                    <i class="fas fa-bell"></i>
                    <span id="notificationBadge" class="notification-badge" style="display: none">
                        0
                    </span>
                </button>
                <div id="notificationDropdown" class="absolute right-0 z-[9999] hidden mt-2 bg-white border border-gray-200 rounded-md shadow-lg w-80 dark:bg-gray-800 dark:border-gray-700">
                    <div class="p-3 border-b border-gray-200 dark:border-gray-700">
                        <div class="flex items-center justify-between">
                            <h3 class="font-medium text-gray-900 dark:text-white">Notifications</h3>
                            <button id="markAllRead" class="text-xs text-blue-600 dark:text-blue-400 hover:underline">Mark all read</button>
                        </div>
                    </div>
                    ...
                    <div class="p-2 text-center border-t border-gray-200 dark:border-gray-700">
                        <a href="{{ route('notifications.index') }}" class="text-sm text-blue-600 dark:text-blue-400 hover:underline">View all</a>
                    </div>
                </div>
            </div>
            @auth
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function renderNotifications(notifications) {
                ...
                notificationList.innerHTML = displayNotifications.map(notification => {
