<x-app-layout>
            ...
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="support-list">
                        ...
                        <div class="support-item" onclick="navigateTo('help-center')">
                            <div class="left">
                                <div class="title">Help Center</div>
                                <div class="subtitle">Guides, Tutorials & Documentation</div>
                            </div>
                            <div class="icon">→</div>
                        </div>
                ...
                <div class="contact-option">
                    ...
                    <div class="contact-info">
                        ...
                        <div class="action-buttons">
                            ...
                            <button class="copy-btn" onclick="copyToClipboard('+11234567890', 'WhatsApp number copied')">
                                Copy Number
                            </button>
                        </div>
                    </div>
            ...
            <div id="emailContent" class="modal-contact-content" style="display: none;">
                <div class="contact-option">
                    ...
                    <div class="contact-info">
                        ...
                        <div class="contact-detail">support@yourdomain.com</div>
                        <div class="action-buttons">
                            <button class="action-btn email" onclick="openEmailClient()">
                                Compose Email
                            </button>
                            <button class="copy-btn" onclick="copyToClipboard('support@yourdomain.com', 'Email address copied')">
                                Copy Email
                            </button>
                        </div>
                    </div>
    ...
    <script>
        ...
        function navigateTo(page) {
            if (page === 'faqs') {
                window.location.href = '{{ route("support.faqs") }}';
        ...
        function startLiveChat() {
            ...
            // window.open('https://yourwebsite.com/livechat', '_blank');
        }
        ...
        function submitCallbackRequest(e) {
            e.preventDefault();
            showToast('Callback request submitted! We\'ll contact you soon.', 'success');
            setTimeout(() => {
                closeModal();
            }, 2000);
        }
        ...
        function checkLiveChatAvailability() {
            ...
            if (isWeekday && isWorkingHours) {
                ...
                liveChatStatus.className = 'status-indicator status-offline';
                liveChatStatus.title = 'Live chat is currently offline';
            }
        }
